...
- 변화 수용
- 소규모 팀에 적합
- 종류: 스크럼, XP, 칸반 (자세한 내용은 Week 9: 애자일/스크럼 참조)
...
## 🎯 실무 적용 예시: CI/CD 파이프라인 구축

### 예시: Node.js API 서비스 CI/CD (제로부터 구축)
...
PM 고민:
"긴급 버그 수정도 1주일 기다려야 하나요?"
```

#### CI/CD 파이프라인 구축 (3주 프로젝트)
