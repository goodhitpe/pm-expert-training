...
### 예시: 글로벌 서비스의 클라우드 아키텍처 결정

#### 상황: 단일 클라우드의 한계

```
회사: 글로벌 SaaS (50개국 서비스)
현재: AWS Only
문제:
- 중국: AWS 접속 불가
- 유럽: GDPR 데이터 주권
- 비용: AWS 종속으로 협상력 없음
- 장애: 2023년 AWS 장애로 12시간 다운

CEO: "멀티 클라우드 전략 검토하세요"
```
...
- 지역별 데이터 배치
  * 미주: AWS us-east-1
  * 유럽: Azure West Europe
  * 아시아: AWS ap-northeast-2
...
✅ 가용성: 99.9% → 99.99%
✅ 비용: 15% 절감 (벤더 경쟁)
✅ 성능: 글로벌 평균 레이턴시 30% 개선
✅ 리스크: 단일 장애점 제거
```

### AWS vs Azure vs GCP 비교 (PM 관점)
